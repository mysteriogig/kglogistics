    ...
    <footer className="bg-[var(--dark)] text-white/80">
      <div className="mx-auto max-w-7xl px-4 py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          <Link to="/" className="flex items-center gap-2.5">
            ...
            <div>
              <div className="font-bold text-white">Universe Freight</div>
              <div className="text-xs text-white/60">Logistics Pvt. Ltd.</div>
            </div>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex gap-3"><MapPin className="h-5 w-5 shrink-0 text-[var(--primary-glow)]" />A9 Shanvika Nivas, Sakthi Garden, TVS Nagar Road, Kavundampalayam, Coimbatore - 641 030</li>
            <li className="flex gap-3"><Phone className="h-5 w-5 shrink-0 text-[var(--primary-glow)]" /><a href="tel:+919566565005">+91 95665 65005</a></li>
            <li className="flex gap-3"><Mail className="h-5 w-5 shrink-0 text-[var(--primary-glow)]" /><a href="mailto:info@universefreightlogistics.com" className="break-all">info@universefreightlogistics.com</a></li>
          </ul>
        </div>
      </div>
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-7xl px-4 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-white/60">
          <p>© {new Date().getFullYear()} Universe Freight Logistics Pvt. Ltd. All rights reserved.</p>
